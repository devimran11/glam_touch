...
class PurchaseController extends Controller
{
    ...
    public function exportPurchaseRecords($start_date,$end_date)
    {
            $purchases=Purchase::whereDate('created_at', '>=', $start_date)
                            ->whereDate('created_at', '<=', $end_date)->with('supplier','purchaseItems')
                            ->get();
