...
{
    protected $fillable=['id', 'name', 'thumbnail_img', 'merchant_id', 'category_id', 'sub_category_id', 'sub_sub_category_id', 'product_code', 'slug', 'stock', 'sale_price', 'discount', 'price', 'wallet_point', 'status', 'campaign_id', 'expired_date', 'product_placement', 'product_position', 'show_home_page', 'details', 'video_url', 'specification', 'size_chart', 'seo_title', 'seo_description', 'created_at', 'updated_at'];
