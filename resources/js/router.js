...
const routes = [
...

    {
        ...
        component: () => import(/* webpackChunkName: "category_new_arrival_products" */'./components/public/CategoryNewArrivalProducts.vue'),
        name: 'category_new_arrival_products',
        meta: {
    ...
    {
        path: '/offer/products',
        component: () => import(/* webpackChunkName: "category_offer_products" */'./components/public/CategoryOfferProducts.vue'),
        name: 'category_offer_products',
        meta: {
    ...
    {
        path: '/backend/colors',
        component: () => import(/* webpackChunkName: "color" */'./components/admin/color/Index.vue'),
        name: "color",
        meta: {
            requiresAuthAdmin: true,
            title: 'color'
    ...
    {
        path: '/backend/colorAdd',
        component: () => import(/* webpackChunkName: "colorAdd" */'./components/admin/color/Add.vue'),
        name: "colorAdd",
        meta: {
            requiresAuthAdmin: true,
            title: 'color || add'
...

   {
    ...
    {
        path: '/backend/product/children/:id',
        component: () => import(/* webpackChunkName: "product_child" */'./components/admin/product/ProductChild.vue'),
        name: 'product_child',
        meta: {
            requiresAuthAdmin: true,
    ...
    {
        path: '/backend/product/child/add/:id',
        component: () => import(/* webpackChunkName: "product_child_add" */'./components/admin/product/ChildAdd.vue'),
        name: 'product_child_add',
        meta: {
            requiresAuthAdmin: true,
            title: 'product child add'
        }
    },


    {
        path: '/backend/product/child/edit/:id',
        component: () => import(/* webpackChunkName: "product_child_edit" */'./components/admin/product/ChildEdit.vue'),
        name: 'product_child_edit',
        meta: {
            requiresAuthAdmin: true,
            title: 'product child edit'
        }
    },
