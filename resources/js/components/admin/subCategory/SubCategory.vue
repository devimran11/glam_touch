                                ...
                                <div class="box-body">
                                    <table class="table table-bordered table-hover table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <th scope="col">Show As Category</th>
                                        ...
                                        <tr v-for="(subCategory,index) in subCategories.data" :key="index" v-else>
                                            ...
                                            <td>  <span style="min-width:70px;"  class="badge badge-success" v-if="subCategory.show_home_page==1"> Publish </span>
                                               <span class="badge badge-warning"  v-else> Unpublish </span> </td>
                                           <td>
