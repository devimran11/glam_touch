              ...
              <div class="box-body">
                ...
                >
                  ...
                  <div class="preview-image text-center ">
                    <img id="previewImage"  class="img-responsive" style="width:160px;height:160px" :src="preview" alt="slider" />
                  </div>
      ...
      axios
        ...
        .then((resp) => {
          ...
          if (resp.data.status == "SUCCESS") {
            ...
            this.form.show_home_page = resp.data.subCategory.show_home_page;
            this.preview= this.$store.state.image_base_link+resp.data.subCategory.image
          } else {
