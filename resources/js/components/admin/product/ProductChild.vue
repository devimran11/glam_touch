  ...
  <div>
    ...
    <div class="content-wrapper">
      <section class="content-header">
        <h1>
          <router-link :to="{ name: 'product_child_add',params:{id:$route.params.id} }" class="btn btn-primary">
                ...
                <div class="box-footer">
                  <div class="row">
                    <div class="col-lg-6">
                      <pagination
                        :data="products"
                        @pagination-change-page="productChildrenList"
                        :limit="3"
                      ></pagination>
                    </div>
                    <div
