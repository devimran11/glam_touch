...
export default {
  ...
  methods: {
    getCrdit(){
       axios.get('/api/showroom/credit/edit/'+this.$route.params.id)
      .then(resp => {
        console.log(resp);
        ...
        this.form.comment=resp.data.credit.comment?resp.data.credit.comment:'';
      });
    },
    updateCredit() {
      this.form
        .post("/api/showroom/credit/update/"+this.$route.params.id)
        .then((resp) => {
