...
Vue.component('frontend-header', require('./components/public/partials/Header.vue').default);
Vue.component('frontend-footer', require('./components/public/partials/Footer.vue').default);

Vue.component('pagination', require('laravel-vue-pagination'));
Vue.component('access', require('./components/admin/AccessDenied.vue'));
Vue.component('quick-view', require('./components/public/partials/QuickView.vue').default)
