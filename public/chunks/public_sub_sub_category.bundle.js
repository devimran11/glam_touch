...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getSubSubCategory: function getSubSubCategory() {
      var _this2 = this;

      axios.get("/_public/sub/sub/category/" + this.$route.params.slug).then(function (resp) {
        //console.log(resp);
        _this2.sub_sub_categories = resp.data.sub_sub_categories;
      });
    },
      ...
      _c(
        ...
        [
          _c(
            ...
            [
              _vm.sub_sub_category_sliders.length > 0
                ? _c("CategorySlider", {
                    attrs: { sliders: _vm.sub_sub_category_sliders }
                  })
                : _vm._e(),
              _vm._v(" "),
              _c(
