...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    validation: function validation() {
      ...
      if (this.preview_products.price.length > 0 && this.preview_products.quantity.length > 0 && this.preview_products.product_id && this.search.length > 0 && this.supplier_id) {
                  ...
                  _c("div", { staticClass: "row" }, [
                    ...
                    _c("div", { staticClass: "col-lg-3" }, [
                      _c("div", { staticClass: "form-group" }, [
                        _c("label", [_vm._v("Supplier Invoice No (optional)")]),
                        _vm._v(" "),
                        _c("input", {
                          directives: [
                            {
