...
Route::group([
  ...
  //start the category route
    ...
    Route::get('api/all/category', 'CategoryController@categoryList');
    ...
    //start the color route
    Route::get('/list/color', 'ColorController@index');
    Route::post('color/add', 'ColorController@store');
    Route::get('api/color/item/{id}', 'ColorController@edit');
    Route::post('api/color/update/{id}', 'ColorController@update');
    Route::get('active/color/{id}', 'ColorController@active');
    Route::get('deActive/color/{id}', 'ColorController@deActive');
    ...
    Route::get('api/edit/product/{id}', 'ProductController@edit');
    Route::post('api/update/product/basicInformation/{id}', 'ProductController@updateBasicInformation');
    ...
    Route::get('export/purchase/records/{start_date}/{end_date}', 'PurchaseController@exportPurchaseRecords');
