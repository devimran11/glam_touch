    ...
    async writeInit() {
      if (typeof this.text === "string") {
        ...
        if (Array.isArray(this.text)) {
          this.arrayTimer = this.setIntervalImmediately(async () => await this.managerArray(), this.timeTakes * 1.4 * 2);
        }
      }
    },
...
const __vue_scope_id__ = "data-v-39ba532d";
/* module identifier */
...
const install = function installVueTypeText(Vue) {
